...
hl.bind(mainMod .. " + SHIFT + W",    hl.dsp.exec_cmd("caelestia wallpaper -f $(zenity --file-selection --file-filter='Imágenes | *.png *.jpg *.jpeg *.webp')"))
hl.bind(mainMod .. " + X",          hl.dsp.exec_cmd("caelestia shell dashboard toggle"))
hl.bind(mainMod .. " + Space",      hl.dsp.exec_cmd("caelestia shell launcher toggle"))
hl.bind(mainMod .. " + period",     hl.dsp.exec_cmd("caelestia emoji"))
hl.bind(mainMod .. " + V",          hl.dsp.exec_cmd("caelestia clipboard"))
hl.bind(mainMod .. " + L",          hl.dsp.exec_cmd("loginctl lock-session"))
hl.bind(mainMod .. " + ALT + C",    hl.dsp.exec_cmd("caelestia shell session toggle"))
