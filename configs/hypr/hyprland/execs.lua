...
hl.on("hyprland.start", function()
    ...
    -- Animated video wallpaper (disabled to allow desktop widgets and static wallpapers)
    -- hl.exec_cmd("sleep 1 && mpvpaper -f -p -o 'no-audio loop hwdec=auto' '*' /home/alberviz/Imágenes/Wallpapers/black-hole2.1920x1080.mp4")
