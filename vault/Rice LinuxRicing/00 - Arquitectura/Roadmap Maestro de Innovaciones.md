...
| ----------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------: | :--------: |
| **Sistema Solar Binario del Escritorio** | Sustituir la columna de widgets por una estrella binaria música–Laura: cada dispositivo, tarea y agente es un cuerpo que orbita y dice su estado de un vistazo. Plan por versiones (v1 solo lectura → v3 gran refactor). Rama `feat/sistema-solar`, ver `docs/sistema-solar-binario.md`. |  🔴 Alta   | 🌟🌟🌟🌟🌟 |
