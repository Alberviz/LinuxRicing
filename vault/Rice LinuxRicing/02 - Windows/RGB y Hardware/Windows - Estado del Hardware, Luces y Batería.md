...
| **Teclado Akko 5075B Plus**        | `VID 0x3151, PID 0x4011` (2.4G)<br>`VID 0x3151, PID 0x4015` (USB) | ✅ **100% Funcional** (Feature Report `0x00`, Opcodes `0x07` y `0x08`) | ✅ **Detectado** (100% Inalámbrico 2.4G / Cable)                                    | **OK**            |
